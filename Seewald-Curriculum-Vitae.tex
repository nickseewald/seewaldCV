...
\begin{document} 
    ...
    \begin{etaremune}
        \item Scientist Reviewer (methodologist), PCORI Merit Review Panel, Phased Large Awards for Comparative Effectiveness Research (PLACER). Patient-Centered Outcomes Research Institute (PCORI). 2026.
