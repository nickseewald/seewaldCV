...
\begin{document} 
	...
	\begin{etaremune}
		\item \textbf{NJ Seewald}, M Cohen*, EE McGinty, and EA Stuart. ``Ready to Roll? Whether and when to aggregate multilevel data in difference-in-differences.'' 
		
		\item \textbf{NJ Seewald}, R Jasper*, and D Almirall. ``Sample size and timepoint tradeoffs for comparing dynamic treatment regimens in a longitudinal SMART.''
	\end{etaremune}
