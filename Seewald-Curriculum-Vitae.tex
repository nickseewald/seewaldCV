...
% EDUCATION ------------------------------------------
 ...
 %        \multicolumn{2}{l}{Johns Hopkins Bloomberg School of Public Health} \\
	...
	\begin{etaremune}
        ...
        \item Anbil S, \textbf{Seewald NJ}, Chiorean EG, Hussein M, Kasi PM, Laux DE, Schwartz GK, Shapiro G, Lin KK, Craib M, Maloney L, McLachlan K, Tukachinsky H, Schrock AB, Wang S, Sokol ES, Decker B, Nathanson KL, Domchek SM, Reiss KA (To Appear) ``LODESTAR: A Single Arm Phase II Study of Rucaparib in Solid Tumors with Pathogenic Germline or Somatic Variants in Homologous Recombination Repair Genes.'' \textit{JCO Precision Oncology}.
