...
\makeatletter
\def\finalstudentcount{0}
\def\finalcommitteecount{0}
\AtEndDocument{%
\immediate\write\@auxout{%
\string\gdef\string\finalstudentcount{\the\value{studentcount}}}%
\immediate\write\@auxout{%
\string\gdef\string\finalcommitteecount{\the\value{committeecount}}}%
}
\AtBeginDocument{%
\setcounter{studentcount}{\startstudentcount}
\addtocounter{studentcount}{-\finalstudentcount}
\stepcounter{studentcount}%
\setcounter{committeecount}{\startcommitteecount}
\addtocounter{committeecount}{-\finalcommitteecount}
\stepcounter{committeecount}%
\immediate\write\@auxout{%
\string\gdef\string\startstudentcount{\the\value{studentcount}}}%
\immediate\write\@auxout{%
\string\gdef\string\startcommitteecount{\the\value{committeecount}}}%
}
\makeatother
...
%			\end{itemize}
    ...
    \begin{tabularx}{\textwidth}{@{\addtocounter{studentcount}{-1}\thestudentcount.\hspace*{\tabcolsep}}XXr}
        Ryan Jasper & Ph.D., Biostatistics & 2025 - Present \\
        Ryan Jasper & M.A., Biostatistics & 2025 - Present \\
