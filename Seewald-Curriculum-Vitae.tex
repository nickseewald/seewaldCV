...
% EDUCATION ------------------------------------------
	...
	\begin{enumerate}
        % \item \underline{Moin EE}, \textbf{Seewald NJ}, Halpern SD (To Appear) ``Outcomes and Use of Life Support Among Patients Admitted to U.S. Intensive Care Units, 2014 – 2023.'' \textit{JAMA}.
	...
	% \subsection*{In Preparation and Under Review}
	%     \begin{enumerate}
 %            \item Eisenberg MD, Tormohlen KN, McCourt AD, Yu J, Neupane R, Ge Y, Rutkow L, Stuart EA, Fingerhood M, \textbf{Seewald NJ}, McGinty, EE ``Impact of State Telemedicine Policies on Substance Use Disorder (SUD) Treatment During COVID-19.''
