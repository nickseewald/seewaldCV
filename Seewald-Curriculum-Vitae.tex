...
\newcommand{\initRevTable}{%
    \setcounter{rowTracker}{-1} %reset row tracker for current table
    % check if count already exists for current table
    \@ifundefined{TableCount\thetable}{%
        \setcounter{currentCountdown}{-1} %first run
    }{%
        %if found, set countdown to the saved value
        \setcounter{currentCountdown}{\csname TableCount\thetable \endcsname}
    }%       
}
...
\AtEndEnvironment{tabularx}{\immediate\write\@auxout{\string\gdef\string\csname TableCount\thetable\endcsname{\therowTracker}}}
...
%			\end{itemize}
    ...
    The currentCountdown is \thecurrentCountdown
    ...
    This table has %\csname\TableCount0\endcsname rows.
